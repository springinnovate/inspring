...
RUN pip3 uninstall pygeoprocessing -y && pip3 install pygeoprocessing==2.3.0 #git+https://github.com/richpsharp/pygeoprocessing.git@65cf904108c1de758f167bfb5c726167793aa56c
